...
(1, 'Handphone', 'Samsung', 2, 9999000, '2024-10-28', '2024-11-09'),
(2, 'TV', 'LG', 2, 14999000, '2024-10-28', '2024-12-24');
...
(33, 'F20241028-001', 1, 'Handphone', 9999000, 1, 9999000, 'dibayar'),
(34, 'F20241028-002', 2, 'TV', 14999000, 1, 14999000, 'dibayar'),
(36, 'F20241028-003', 1, 'Handphone', 9999000, 2, 19998000, 'dibayar');
...
--
ALTER TABLE `tb_sales`
  MODIFY `id_sales` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
COMMIT;
